 ...
 * - Playwright, AdmZip (para ZIPs), fast-xml-parser (para XMLs)
 * - fs, path, os para manipular arquivos e pastas
 * - readline para pausas e inputs no terminal
 * ===============================================================
 */
...
// (REMOVIDO) lerChaves() não é mais necessário.
...
/**
 * ===============================================================
 * BLOCO 3 — INICIAR ENTRADA DA NOTA E EXTRAIR DADOS DO XML
 * ===============================================================
 */
async function iniciarEntradaComDadosXML(page, chave, xmlContent) {
  // 1. Extrai dados do XML para exibir no terminal
...
/**
 * ===============================================================
 * BLOCO 8 — PROCESSAR UMA NOTA COMPLETA (PIPELINE)
 * ===============================================================
 */
...
(async () => {
  ...
  await pause('Pressione Enter para fechar o navegador...');
  await context.close();
  await browser.close();
})();